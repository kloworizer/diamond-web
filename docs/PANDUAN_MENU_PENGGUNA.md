...
| Data Prioritas | Badge informasi saja (bukan field yang diisi pengguna) — terisi otomatis lewat API `check-jenis-prioritas` bila Jenis Data tsb terdaftar sebagai prioritas untuk tahun terpilih; ditetapkan otomatis ke tiket saat disimpan bila cocok. |
