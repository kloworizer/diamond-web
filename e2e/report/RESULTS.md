...
_Generated: 2026-07-24 15:37:28_

**Steps:** 48 passed, 1 failed. **Bugs found:** 3.
...
|---|---|---|---|
| happy_path | rekam tiket | PASS | AS001010126072402 -> Direkam |
...
| langsung_selesai | rekam tiket | PASS | AS001010126072403 -> Selesai |
| langsung_selesai | status after rekam (data tidak tersedia) | PASS | Selesai |
| penelitian_tidak_lengkap | rekam tiket | PASS | AS001010126072404 -> Direkam |
...
| batalkan | rekam tiket | PASS | AS001010126072405 -> Direkam |
...
| dikembalikan | rekam tiket | PASS | AS001010126072406 -> Direkam |
...
| val_penelitian_negative | rekam tiket | PASS | AS001010126072407 -> Direkam |
...
| val_pide_pmde_gaps | rekam tiket | PASS | AS001010126072408 -> Direkam |
