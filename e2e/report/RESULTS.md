...
_Generated: 2026-07-26 17:34:08_

**Steps:** 125 passed, 1 failed. **Bugs found:** 3.
...
### 3. [HIGH] Selesaikan Tiket has NO server-side validation of QC totals

The Selesaikan modal promises 'Lolos QC + Tidak Lolos QC harus sama dengan Baris I', but SelesaikanTiketForm defines no clean() and the view saves whatever is posted. Submitting lolos_qc=1, tidak_lolos_qc=1 (sum 2, unrelated to Baris I) completed the tiket to 'Selesai'. The check is client-side only and is trivially bypassed.
...
| val_pide_pmde_gaps | selesaikan tiket | PASS | -> Selesai (open_btn_was_disabled=True) |
| val_pide_pmde_gaps | invalid QC accepted | FAIL | status -> Selesai |
...
| crud_kategori_ilap | valid create | PASS | E6/E2E Kategori ILAP 65 |
...
| crud_periode_pengiriman | valid create | PASS | E2E Penyampaian 9214 |
| crud_periode_pengiriman | edit | PASS |  |
| crud_periode_pengiriman | delete | PASS |  |
| crud_dasar_hukum | empty submit blocked | PASS |  |
| crud_dasar_hukum | valid create | PASS | E2E Dasar Hukum 16896 |
...
| crud_kpp | valid create | PASS | Q13/E2E KPP 134 kanwil=1 |
| crud_kpp | edit | PASS |  |
