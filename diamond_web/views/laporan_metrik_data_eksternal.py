...
def _get_filtered_tikets(params):
    ...
    tgl_transfer), ILAP, Jenis Data, Sub Jenis Data, and Tabel I.
    Results are ordered by tgl_transfer ascending.
...
class LaporanMetrikDataEksternalView(LoginRequiredMixin, UserPassesTestMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        """Add the metrik data eksternal filter form to the template context.
...
def laporan_metrik_data_eksternal_export(request):
    ...
    Uses the LaporanMetrikDataEksternalExportResource to generate an XLSX file from
