...
def _get_filtered_tikets(params):
    ...
    tgl_kirim_pide), ILAP, Jenis Data, Sub Jenis Data, and Tabel I.
...
class LaporanSLAPerekamanView(LoginRequiredMixin, UserPassesTestMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        """Add the SLA perekaman filter form to the template context.
...
def laporan_sla_perekaman_export(request):
    ...
    Uses the LaporanSLAPerekamanExportResource to generate an XLSX file from
