...
class KategoriWilayahCreateView(LoginRequiredMixin, AdminRequiredMixin, CreateView):
...
class KategoriWilayahUpdateView(LoginRequiredMixin, AdminRequiredMixin, UpdateView):
    model = KategoriWilayah
    form_class = KategoriWilayahForm
    template_name = 'kategori_wilayah/form.html'
    success_url = reverse_lazy('kategori_wilayah_list')
