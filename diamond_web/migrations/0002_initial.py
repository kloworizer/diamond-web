# Generated by Django 5.2.12 on 2026-04-06 13:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('id_ilap', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='kanwil_kpp', to='diamond_web.ilap', verbose_name='ILAP')),
                ('id_kpp', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ilap_kanwil', to='diamond_web.kpp', verbose_name='KPP')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('nomor_tiket', models.CharField(blank=True, max_length=17, null=True, verbose_name='Nomor Tiket')),
                ('status_tiket', models.IntegerField(blank=True, null=True, verbose_name='Status Tiket')),
                ('periode', models.IntegerField(blank=True, null=True, verbose_name='Periode')),
                ('penyampaian', models.IntegerField(blank=True, null=True, verbose_name='Penyampaian')),
                ('nomor_surat_pengantar', models.CharField(blank=True, max_length=50, null=True, verbose_name='Nomor Surat Pengantar')),
                ('tanggal_surat_pengantar', models.DateTimeField(blank=True, null=True, verbose_name='Tanggal Surat Pengantar')),
                ('nama_pengirim', models.CharField(blank=True, max_length=50, null=True, verbose_name='Nama Pengirim')),
                ...
                ('tahun', models.IntegerField(blank=True, null=True, verbose_name='Tahun')),
                ('baris_p3de', models.IntegerField(blank=True, null=True, verbose_name='Baris P3DE')),
                ('tgl_terima_vertikal', models.DateTimeField(blank=True, null=True, verbose_name='Tanggal Terima Vertikal')),
                ('tgl_terima_dip', models.DateTimeField(blank=True, null=True, verbose_name='Tanggal Terima DIP')),
                ...
                ('id_bentuk_data', models.ForeignKey(blank=True, db_column='bentuk_data', null=True, on_delete=django.db.models.deletion.PROTECT, to='diamond_web.bentukdata', verbose_name='Bentuk Data')),
                ('id_cara_penyampaian', models.ForeignKey(blank=True, db_column='cara_penyampaian', null=True, on_delete=django.db.models.deletion.PROTECT, to='diamond_web.carapenyampaian', verbose_name='Cara Penyampaian')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_file', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nama File')),
                ...
                ('id_media_backup', models.ForeignKey(blank=True, db_column='media_backup', null=True, on_delete=django.db.models.deletion.PROTECT, to='diamond_web.mediabackup', verbose_name='Media Backup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp', models.DateTimeField(blank=True, null=True, verbose_name='Timestamp')),
                ('role', models.IntegerField(blank=True, choices=[(1, 'P3DE'), (2, 'PIDE'), (3, 'PMDE')], null=True, verbose_name='Role')),
                ('active', models.BooleanField(default=True, verbose_name='Active')),
                ('id_tiket', models.ForeignKey(db_column='id_tiket', on_delete=django.db.models.deletion.PROTECT, to='diamond_web.tiket', verbose_name='Tiket')),
                ('id_user', models.ForeignKey(db_column='id_user', on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
